		...
		return {
			...
			industria: {
				cod: 11, valores: [
					...
					{ value: 8, label: properties.lbl_enum_industria_maquinados },
					...
					{ value: 13, label: properties.lbl_enum_industria_seguridad },
					{ value: 14, label: properties.lbl_enum_industria_transporte },
					{ value: 15, label: properties.lbl_enum_industria_maritima },
					{ value: 16, label: properties.lbl_enum_industria_centro_oncologico },
					{ value: 17, label: properties.lbl_enum_industria_hospital },
					{ value: 18, label: properties.lbl_enum_industria_eventos },
					{ value: 19, label: properties.lbl_enum_industria_servicios_publicos }
				]
			},
			//valorIva: {cod: 25},
		}
