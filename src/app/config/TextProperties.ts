...
export class TextProperties {
	...
	getProperties(idioma: number) {
		...
		return {
			...
			lbl_enum_proceso_contacto_valor_potencial_perdida: idioma === constant.idiomaEs ? 'Persona Indicada' : 'Ideal Person',
			...
			lbl_enum_industria_maquinados: idioma === constant.idiomaEs ? 'Maquinados' : 'Machining',
			...
			lbl_enum_industria_seguridad: idioma === constant.idiomaEs ? 'Seguridad Privada' : 'Private Security',
			lbl_enum_industria_transporte: idioma === constant.idiomaEs ? 'Transporte y Logística' : 'Logistic and Transport',
			lbl_enum_industria_maritima: idioma === constant.idiomaEs ? 'Marítima y Puertos' : 'Maritime and Ports',
